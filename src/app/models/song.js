...
const SongSchema = new mongoose.Schema({
	...
	sections: {
		type: Array,
		required: true,
		validate: [checkSectionLength, "needs at least 2 elements"]
	},
	createdAt: {
		type: Date,
		select: false
...
function checkSectionLength(val) {
	return !(val.length < 2);
}
...
"layout": "5",
	...
	"albumadamid": "485353575",
	"sections": [
	  {
		"type": "SONG",
		"metapages": [
		  {
			"image": "https://is4-ssl.mzstatic.com/image/thumb/Features115/v4/3f/84/4e/3f844e97-8c23-b64d-87f1-d536e99f80e9/mzl.rsxdpqqq.jpg/800x800cc.jpg",
			"caption": "Yiruma"
		  },
		  {
			"image": "https://is5-ssl.mzstatic.com/image/thumb/Music125/v4/b5/ae/26/b5ae2651-542a-9ee9-be4c-278791e2918f/mzi.ncrxyndi.jpg/400x400cc.jpg",
			"caption": "River Flows In You"
		  }
		],
		"tabname": "Song",
		"metadata": [
		  {
			"title": "Album",
			"text": "The Best - Reminiscent 10th Anniversary"
		  },
		  {
			"title": "Label",
			"text": "SME Korea Inc."
	  ...
	  },
	  {
		...
		"youtubeurl": {
		  ...
		  "image": {
			...
			"url": "https://i.ytimg.com/vi/7maJOI3QMu0/maxresdefault.jpg"
		  },
		  "actions": [
			{
			  "name": "video:youtube",
			  ...
			  "share": {
				...
				"image": "https://is5-ssl.mzstatic.com/image/thumb/Music125/v4/b5/ae/26/b5ae2651-542a-9ee9-be4c-278791e2918f/mzi.ncrxyndi.jpg/400x400cc.jpg",
				"twitter": "I used @Shazam to discover River Flows In You by Yiruma.",
				"html": "https://www.shazam.com/snippets/email-share/40333609?lang=-&country=US",
				"avatar": "https://is4-ssl.mzstatic.com/image/thumb/Features115/v4/3f/84/4e/3f844e97-8c23-b64d-87f1-d536e99f80e9/mzl.rsxdpqqq.jpg/800x800cc.jpg",
				"snapchat": "https://www.shazam.com/partner/sc/track/40333609"
			  },
			  "uri": "https://youtu.be/7maJOI3QMu0?autoplay=1"
			}
		  ]
		}
	  },
